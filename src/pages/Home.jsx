...
function TrustMarquee() {
  ...
  return (
    <div
      ...
      style={{ background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.08)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}
    >
      <motion.div
...
function FeatureSection({ label, heading, body, linkText = 'Learn more', linkTo = '/solutions', mockup, reverse = false }) {
  return (
    <section
      ...
      style={{ background: 'rgba(4,5,16,0.58)', borderTop: '1px solid rgba(255,255,255,0.07)' }}
    >
...
function TechStackSection() {
  return (
    <section className="py-20 px-6 md:px-14" style={{ background: 'rgba(255,255,255,0.04)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
...
function MethodologySection() {
  return (
    <section className="py-28 px-6 md:px-14" style={{ background: 'rgba(4,5,16,0.58)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
...
function CaseStudiesSection() {
  return (
    <section className="py-28 px-6 md:px-14" style={{ background: 'rgba(255,255,255,0.04)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
      <div className="max-w-7xl mx-auto">
...
function IndustriesSection() {
  return (
    <section className="py-20 px-6 md:px-14" style={{ background: 'rgba(4,5,16,0.58)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
      <div className="max-w-7xl mx-auto">
        <FadeUp className="text-center mb-12">
...
function FAQSection() {
  ...
  return (
    <section className="py-24 md:py-32 px-6 md:px-14" style={{ background: 'rgba(255,255,255,0.04)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
...
function CTASection() {
  return (
    <section className="py-24 px-6 md:px-14" style={{ background: 'rgba(4,5,16,0.58)', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
