...
function FeatureSection({ label, heading, body, linkText = 'Learn more', linkTo = '/solutions', mockup, reverse = false }) {
  return (
    <section
      className="py-24 md:py-28 px-6 md:px-14 overflow-hidden"
...
function TechStackSection() {
  return (
    <section className="py-20 px-6 md:px-14" style={{ background: 'var(--surface-raised)' }}>
...
function MethodologySection() {
  return (
    <section className="py-28 px-6 md:px-14 relative overflow-hidden" style={{ background: 'var(--surface-base)' }}>
...
function CaseStudiesSection() {
  return (
    <section className="py-28 px-6 md:px-14" style={{ background: 'var(--surface-raised)' }}>
...
function TestimonialsSection() {
  return (
    <section className="py-28 px-6 md:px-14" style={{ background: 'var(--surface-base)' }}>
      <div className="max-w-7xl mx-auto">
...
function IndustriesSection() {
  return (
    <section className="py-20 px-6 md:px-14" style={{ background: 'var(--surface-base)' }}>
      <div className="max-w-7xl mx-auto">
        <FadeUp className="text-center mb-12">
...
function FAQSection() {
  ...
  return (
    <section className="py-24 md:py-32 px-6 md:px-14" style={{ background: 'var(--surface-raised)' }}>
...
function CTASection() {
  return (
    <section className="py-24 px-6 md:px-14" style={{ background: 'var(--surface-base)' }}>
