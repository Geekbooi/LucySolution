...
const socials = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/masreshayoseph1/',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/Geekbooi',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/joseph_mekonnen/',
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2.5">
              <a href="mailto:hello@lucysolution.com" className="flex items-center gap-2.5 text-sm text-white/45 hover:text-white/75 transition-colors">
                <Mail size={14} className="text-blue-400 shrink-0" />
                hello@lucysolution.com
              </a>
